...
def check_p_values():
    ...
    print("The empirical fractions should be slghtly less than p values")
...
def check_p_values_less():
    ...
    print("The empirical fractions should be slightly less than p values")
...
def generate_data():
    ...
    yy_bp = intercept + alpha*xx_bp + beta_1 * \
        np.maximum(xx_bp - breakpoint_1, 0) + np.random.normal(size=len(xx_bp))
